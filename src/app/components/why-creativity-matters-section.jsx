import { Brain, Rocket, Lightbulb, TrendingUp, ArrowRight, BookOpen, Code2, Megaphone, AlertTriangle, Clock, TrendingDown, Target, Zap, Award } from 'lucide-react';
...
export default function WhyCreativityMattersSection() {
  ...
  const parentChallenges = [
    {
      ...
      description: "Your child spends hours gaming or on YouTube, but you worry they're not learning anything valuable for their future.",
    ...
    },
    {
      ...
      description: "AI is everywhere, but traditional schools aren't teaching these skills. You want your child prepared for tomorrow's world.",
    ...
    },
    {
      ...
      description: "Your child is smart but struggles with problem-solving and presenting ideas. They need skills that build real confidence.",
  ...
  const ourSolutions = [
    {
      ...
      description: "Transform passive consumption into active creation. Build real projects while having fun.",
    ...
    },
    {
      ...
      description: "Master AI tools, coding fundamentals, and entrepreneurship - the exact skills for tomorrow's world.",
    ...
    },
    {
      ...
      description: "Present startup ideas to actual entrepreneurs and investors. Watch shy kids become confident leaders.",
  ...
  return (
    <section 
      className="py-16 lg:py-24 bg-gradient-to-br from-slate-50 via-purple-50 to-indigo-50 relative overflow-hidden"
    >
          ...
          <div className="lg:col-span-3">
            ...
            <div className="text-center lg:text-left mb-12">
              <div className="inline-flex items-center space-x-3 bg-gradient-to-r from-red-500 to-orange-500 text-white px-6 py-3 rounded-full shadow-lg shadow-red-500/30 mb-4">
                ...
                <span className="font-bold text-sm font-poppins tracking-wide">PARENT CHALLENGES</span>
              </div>
              <p className="text-slate-600 text-base font-medium">Common concerns every parent has about their child's future</p>
            </div>
                  ...
                  >
                    <div className="relative">
                      <div className="flex items-start space-x-6">
                        ...
                        <div className={`flex-shrink-0 w-16 h-16 bg-gradient-to-r ${card.gradient} rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                          <span className="text-white font-black text-2xl">{card.number}</span>
                        </div>
                        
                        {/* Improved Content Layout */}
                        <div className="flex-1 min-w-0 pt-2">
                          <h4 className="text-2xl lg:text-3xl font-bold text-slate-900 font-poppins mb-4 leading-tight">{card.title}</h4>
                          <p className="text-slate-700 text-lg leading-relaxed">{card.description}</p>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="text-left mb-12">
              <div className="inline-flex items-center space-x-3 bg-gradient-to-r from-emerald-500 to-teal-500 text-white px-6 py-3 rounded-full shadow-lg shadow-emerald-500/30 mb-4">
                ...
                <span className="font-bold text-sm font-poppins tracking-wide">HOW WE SOLVE IT</span>
              </div>
              <p className="text-slate-600 text-base font-medium">Proven solutions that work for thousands of families</p>
            </div>
                  ...
                  {ourSolutions.map((step, index) => {
                    ...
                    return (
                      <div key={index} className="flex items-start space-x-6">
                        {/* Larger Icon */}
                        <div className={`flex-shrink-0 w-16 h-16 ${step.iconBg} rounded-xl flex items-center justify-center shadow-md`}>
                          <Icon className="w-8 h-8 text-white" />
                        </div>
                        
                        {/* Enhanced Content */}
                        <div className="flex-1 min-w-0">
                          <h4 className="text-xl lg:text-2xl font-bold text-slate-900 font-poppins mb-3 leading-tight">{step.title}</h4>
                          <p className="text-slate-700 text-base lg:text-lg leading-relaxed">{step.description}</p>
                        </div>
                      </div>
                    );
                  })}
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            ...
            <div className="flex-1 text-center lg:text-left">
              <div className="inline-flex items-center space-x-3 bg-gradient-to-r from-yellow-400 to-orange-400 text-slate-900 px-6 py-3 rounded-full shadow-lg shadow-yellow-400/30 mb-4">
                <span className="font-bold text-sm font-poppins tracking-wide">OUR SOLUTIONS</span>
              </div>
