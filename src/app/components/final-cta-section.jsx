        ...
        <div className="text-center space-y-12">
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-sm text-white px-6 py-3 rounded-full border border-white/20">
              ...
              <span className="font-semibold text-sm font-poppins">Ready to Launch Your Child's Future?</span>
            </div>
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed font-poppins">
              Join hundreds of families who've already given their kids the ultimate competitive advantage. 
              Your child's entrepreneurial journey starts with a single click.
            </p>
          </div>
