...
//               >
//                 <iframe
//                   src="https://drive.google.com/file/d/1WevSQp3CHnxV_Vv4m_hV_jc1VO4X6zA-/preview"
//                   width="100%"
//                   height="500"
//                   allow="autoplay"
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-screen py-6">
          ...
          <div className="flex items-center justify-center relative">
            <div className="relative w-full max-w-2xl mx-auto p-4 sm:p-6">
              ...
              <div className="absolute -inset-4 bg-gradient-to-r from-fuchsia-500/30 via-indigo-500/30 to-cyan-400/30 rounded-3xl blur-2xl animate-pulse"></div>

              {/* Glassmorphism video container */}
              <div className="relative z-10 bg-white/10 backdrop-blur-lg border border-white/20 rounded-3xl shadow-2xl overflow-hidden hover:scale-[1.02] transition-transform duration-500 ease-out">
              ...
              <div className="text-center mt-6">
                <h3 className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-yellow-400 via-pink-500 to-purple-600 bg-clip-text text-transparent">
                  Watch How InnoKidz Sparks Innovation 💡
                </h3>
                <p className="text-white/70 mt-2 text-sm sm:text-base font-medium">
                  A glimpse into how we’re shaping the next generation of young
                  entrepreneurs.
                </p>
              </div>
            </div>
