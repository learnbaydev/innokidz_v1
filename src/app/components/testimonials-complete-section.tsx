...
//       image: "👩‍💼",
//       content: "My 12-year-old built her first app in just 3 weeks! She's not just learning to code - she's learning to think like an entrepreneur. The confidence boost has been incredible.",
//       rating: 5,
...
//       image: "👦",
//       content: "I used to think coding was boring, but now I'm building my own social media app! The AI stuff is super cool - it's like having a coding buddy that never gets tired.",
//       rating: 5,
...
//       image: "👨‍💻",
//       content: "As a developer myself, I'm impressed by the curriculum. It's not just teaching syntax - it's teaching problem-solving and entrepreneurial thinking. My daughter is already pitching me startup ideas!",
//       rating: 5,
...
//                 <span className={`px-3 py-1 text-xs font-bold text-white bg-gradient-to-r ${testimonial.gradient} rounded-full`}>
...
//               {/* Hover glow effect */}
//               <div className={`absolute inset-0 bg-gradient-to-r ${testimonial.gradient} opacity-0 group-hover:opacity-5 rounded-3xl transition-opacity duration-500`}></div>
//             </div>
//           ))}
//         </div>
