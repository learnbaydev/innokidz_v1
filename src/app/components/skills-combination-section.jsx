import { Monitor, Brain, Mic, ArrowRight, CheckCircle, ChevronLeft, ChevronRight, Zap, Star } from 'lucide-react';
  ...
  const skills = [
    {
      ...
      description: "Start with ChatGPT, Midjourney, and coding assistants - become an AI power user in days",
      stat: "8+ AI Tools Mastered",
      features: ["ChatGPT for Research", "Midjourney for Graphics", "GitHub Copilot for Code", "Claude for Writing"],
      color: "cyan",
      gradient: "from-cyan-500 to-blue-500",
      bgGradient: "from-cyan-50 to-blue-50",
      rightContent: {
        headline: "AI-First Generation",
        subtext: "Your child will learn tools that 90% of adults don't know how to use",
    ...
    },
    {
      ...
      description: "Code working apps, design stunning websites, and create games people actually want to play",
      stat: "3 Complete Projects", 
      features: ["Interactive Web Apps", "Mobile-Ready Games", "Professional Websites", "API Integrations"],
      color: "purple",
      gradient: "from-purple-500 to-pink-500",
      bgGradient: "from-purple-50 to-pink-50",
      rightContent: {
        headline: "Portfolio Before High School",
        subtext: "Graduate with a GitHub portfolio that impresses college admissions and employers",
    ...
    },
    {
      ...
      description: "Present your startup idea to real mentors, get feedback, and learn what it takes to go viral",
      stat: "Live Investor Pitch",
      features: ["Pitch Deck Creation", "Demo Day Presentation", "Mentor Feedback", "Marketing Strategy"],
      color: "orange",
      gradient: "from-orange-500 to-red-500",
      bgGradient: "from-orange-50 to-red-50",
      rightContent: {
        headline: "Real Startup Experience",
        subtext: "Your child presents to actual entrepreneurs and investors - not just teachers",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16 lg:mb-20">
          <h2 className="text-3xl lg:text-4xl xl:text-5xl font-black text-slate-900 leading-tight font-poppins mb-6">
            <span className="text-transparent bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text">4 Weeks.</span>
            {" "}
            <span className="text-transparent bg-gradient-to-r from-orange-600 to-red-600 bg-clip-text">Real Results.</span>
          </h2>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="relative bg-white rounded-3xl shadow-2xl overflow-hidden border border-slate-200">
            ...
            {/* Animated Background */}
            <div className={`absolute inset-0 bg-gradient-to-br ${skills[activeSlide].bgGradient} transition-all duration-700 ease-in-out`}></div>
            ...
            <div className="relative z-10 grid lg:grid-cols-2 gap-0 min-h-[420px]">
              ...
              <div className="p-8 lg:p-12 flex flex-col justify-center">
                ...
                <div className="flex items-center mb-4">
                  <div className={`w-12 h-12 bg-gradient-to-r ${skills[activeSlide].gradient} rounded-xl flex items-center justify-center shadow-lg ${isAnimating ? 'scale-110' : 'scale-100'} transition-transform duration-300`}>
                    {(() => {
                ...
                <div className="grid grid-cols-2 gap-2 mb-4">
                  {skills[activeSlide].features.map((feature, index) => (
                    <div 
                      key={index} 
                      className={`flex items-center space-x-2 opacity-0 animate-[fadeInUp_0.5s_ease-out_${index * 0.1}s_forwards]`}
                    >
                      <Star className={`w-3.5 h-3.5 text-${skills[activeSlide].color}-500 flex-shrink-0`} />
                ...
                {/* Stat Badge */}
                <div className={`inline-flex items-center bg-gradient-to-r ${skills[activeSlide].gradient} text-white px-4 py-2 rounded-full text-sm font-bold shadow-lg max-w-fit`}>
              ...
              <div className="relative p-8 lg:p-12 flex flex-col justify-center bg-gradient-to-br from-white/50 to-transparent">
                ...
                <div className="text-center">
                  ...
                  <div className="mb-6 flex justify-center">
                    <div className={`w-56 h-40 rounded-2xl shadow-xl ${isAnimating ? 'scale-105' : 'scale-100'} transition-all duration-500 relative overflow-hidden`}>
                      <img 
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="bg-white/80 backdrop-blur-sm rounded-lg p-3 border border-slate-200">
                      <div className="text-base font-bold text-slate-900">{skills[activeSlide].rightContent.timeline}</div>
                      <div className="text-xs text-slate-600">Timeline</div>
                    </div>
                    <div className="bg-white/80 backdrop-blur-sm rounded-lg p-3 border border-slate-200">
                      <div className="text-base font-bold text-slate-900">{skills[activeSlide].rightContent.metric}</div>
