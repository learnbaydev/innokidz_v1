  ...
  const futureProfessions = [
    {
      ...
      description:
        "By 2030, coding will be as essential as reading. Your child gets a 6-year head start.",
    ...
    },
    {
      ...
      description:
        "The fastest-growing role in tech. Companies desperately need people who understand both AI and business.",
    ...
    },
    {
      ...
      description:
        "Young founders are taking over. Mark Zuckerberg, Evan Spiegel, and others started as teenagers.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-100 to-pink-100 rounded-full px-6 py-2 mb-6">
            ...
            <span className="text-purple-700 font-semibold text-sm font-poppins">
            ...
            return (
              <div
                ...
                className={`group relative bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-purple-200 overflow-hidden ${
                  career.highlighted
                    ? "border-2 border-purple-400 transform -translate-y-2 shadow-2xl"
                    : ""
                }`}
              >
                {/* Gradient Background Effect */}
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${career.gradient} opacity-0 group-hover:opacity-5 transition-opacity duration-500 rounded-3xl`}
                ></div>
                ...
                {/* Icon */}
                <div
                  className={`relative w-16 h-16 rounded-2xl bg-gradient-to-br ${career.gradient} flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg`}
                >
                ...
                <div className="relative">
                  ...
                  <div className="space-y-3">
                    {career.features.map((feature, featureIndex) => (
                      ...
                      >
                        <div
                          className={`w-2.5 h-2.5 rounded-full bg-gradient-to-r ${career.gradient} mr-3`}
                        ></div>
                ...
                {/* Hover Effect Line */}
                <div
                  className={`absolute bottom-0 left-0 h-1 w-0 bg-gradient-to-r ${career.gradient} group-hover:w-full transition-all duration-500`}
                ></div>
              </div>
            );
          })}
          ...
          <div className="bg-gradient-to-r from-purple-600 via-purple-700 to-pink-600 rounded-3xl p-12 md:p-16 text-white text-center relative overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10 max-w-4xl mx-auto">
              ...
              <p className="text-xl md:text-2xl text-white/90 mb-12 font-poppins leading-relaxed">
                While other kids play games, your child could be building the
                skills that create millionaires.
              </p>
