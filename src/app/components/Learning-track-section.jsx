...
export default function LearningTrackSection() {
  ...
  const currentWeekData = weeklyProgram[selectedWeek];
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            {[1, 2, 3, 4].map((week) => (
              <button
                ...
                className={`px-8 py-4 rounded-xl font-bold text-lg transition-all duration-300 ${
                  selectedWeek === week
                    ? `bg-gradient-to-r ${currentWeekData.bgGradient} text-white shadow-lg`
        ...
        <div className="relative">
          <div
            className={`bg-gradient-to-br ${currentWeekData.bgGradient} rounded-3xl p-8 lg:p-12 shadow-xl border-2 border-gray-200`}
          >
            {/* Week Header */}
            <div className="text-center mb-12">
              <h3 className="text-3xl lg:text-4xl font-black text-gray-900 mb-4 font-poppins">
                Week {selectedWeek}: ${currentWeekData.title}
              </h3>
            </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="absolute -top-4 left-8">
                      <div
                        className={`w-8 h-8 bg-gradient-to-r ${currentWeekData.bgGradient}text-white rounded-full flex items-center justify-center font-black text-sm shadow-lg`}
                      >
                        {day.day}
                      </div>
                    </div>
                    ...
                    <div className="relative">
                      {/* Icon */}
                      <div
                        className={`w-16 h-16 bg-gradient-to-r ${currentWeekData.bgGradient} rounded-2xl flex items-center justify-center shadow-lg shadow-purple-500/25 mb-6 group-hover:scale-110 transition-transform duration-300`}
                      >
                      ...
                      <div>
                        ...
                        {/* <ul className="space-y-3">
                          {day.activities.map((activity, activityIndex) => (
                            ...
                            >
                              <div
                                className={`w-2 h-2 bg-gradient-to-r ${currentWeekData.bgGradient} rounded-full mt-2 flex-shrink-0`}
                              ></div>
